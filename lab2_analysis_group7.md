...
plt.ylabel('pH')
plt.title('NaHCO3 pH vs. Dimensionless Hydraulic Residence Time')
ax.legend(['pH'])
...
# Part 2: CMFR graph
pHin = 3
C_initial_open = epa.ANC_open(lakepH[240])
...
plt.xlabel('Hydraulic Residence Time')
plt.ylabel('ANC')
plt.title('NaHCO3 Expected ANC in the lake effluent (CMFR) versus hydraulic residence time')
ax.legend(['Conservative ANC'])
...
plt.xlabel('Hydraulic Residence Time')
plt.ylabel('ANC')
plt.title('NaHCO3 Expected ANC of closed/open System vs Hydraulic Residence Time')
...
plt.xlabel('Hydraulic Residence Time')
plt.ylabel('pH')
plt.title('CaCO3 pH vs. Dimensionless Hydraulic Residence Time')
ax.legend(['pH'])
...
# Part 2: CMFR graph
pHin = 3
C_initial_open_2 = epa.ANC_open(lakepH_2[start_2])
C_influent = (-10)**-pHin* u.eq/u.L
...
plt.xlabel('Hydraulic Residence Time')
plt.ylabel('ANC')
plt.title('CaCO3 Expected ANC in the lake effluent (CMFR) versus hydraulic residence time')
ax.legend(['Conservative ANC'])
...
plt.xlabel('Hydraulic Residence Time')
plt.ylabel('ANC')
plt.title('Ca Expected ANC of closed/open System vs Hydraulic Residence Time')
ax.legend(['ANC closed system','ANC open system'])
